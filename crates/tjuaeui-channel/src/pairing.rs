...
use tjuaeui_api_types::{PairingRequestedPayload, UserAuthorizedPayload, WebSocketMessage};
use tjuaeui_common::{TimestampMs, generate_id, now_ms};
use tjuaeui_db::IChannelRepository;
use tjuaeui_db::models::{AssistantUserRow, PairingCodeRow};
...
mod tests {
    use super::*;
    use std::sync::Mutex;
    use tjuaeui_db::models::{AssistantSessionRow, AssistantUserRow, ChannelPluginRow, PairingCodeRow};
    use tjuaeui_db::{DbError, IChannelRepository, UpdatePluginStatusParams};
