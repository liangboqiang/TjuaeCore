...
mod weixin_tests {
    ...
    use tjuaeui_channel::manager::{ChannelManager, PluginFactory};
    use tjuaeui_channel::plugin::ChannelPlugin;
    use tjuaeui_channel::plugins::weixin::WeixinPlugin;
    use tjuaeui_channel::types::{PluginConfig, PluginCredentials, PluginStatus, PluginType};
    ...
    fn login_event_qr_serializes_correctly() {
        use tjuaeui_channel::plugins::weixin::weixin_login_stream;
