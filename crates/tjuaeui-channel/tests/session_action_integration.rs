...
use tjuaeui_channel::session::SessionManager;
use tjuaeui_channel::types::{
...
async fn action_session_new() {
    ...
    match result {
        MessageResult::Action(resp) => {
            ...
            // With no client_preferences, defaults to "tjuaecli"
...
// tjuaeui-db sqlite_channel.rs::update_session_conversation_persists.
