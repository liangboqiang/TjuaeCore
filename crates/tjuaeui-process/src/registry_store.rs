...
//!
//! Lives in its own subdir `{data_dir}/runtime/tjuaeui-process/registry.json`,
...
pub const SUBDIR: &str = "runtime/tjuaeui-process";
...
/// File-backed registry under `{data_dir}/runtime/tjuaeui-process/registry.json`.
