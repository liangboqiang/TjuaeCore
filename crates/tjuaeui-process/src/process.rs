...
impl Drop for ManagedProcess {
    ...
    /// Builder Child in tjuaeui-runtime spawn.rs) — when the exit-monitor task
...
/// (workspace-availability regression); upstream removed the same check from the legacy
...
mod tests {
    ...
    /// Workspace-availability regression: a workspace with
