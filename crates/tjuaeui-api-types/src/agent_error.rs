...
pub enum AgentErrorCode {
    #[serde(rename = "TJUAE_CONVERSATION_BUSY")]
    TjuaeUIConversationBusy,
    #[serde(rename = "TJUAE_STREAM_BROKEN")]
    TjuaeUIStreamBroken,
    #[serde(rename = "TJUAE_STATE_INCONSISTENT")]
    TjuaeUIStateInconsistent,
    #[serde(rename = "TJUAE_PERMISSION_ERROR")]
...
mod tests {
    ...
    fn classified_error_serializes_resolution() {
        ...
        let json = serde_json::to_value(payload).unwrap();
        assert_eq!(json["code"], "TJUAE_CONVERSATION_BUSY");
        assert_eq!(json["ownership"], "tjuae");
