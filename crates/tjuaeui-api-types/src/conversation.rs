...
///
/// `model` is the canonical top-level field **only for `AgentType::TjuaeCli`**.
...
mod tests {
    ...
    fn deserialize_create_request_full() {
        ...
        assert_eq!(req.source, Some(ConversationSource::TjuaeUI));
    ...
    fn serialize_conversation_response_snake_case() {
        let resp = ConversationResponse {
            ...
            runtime: None,
            source: Some(ConversationSource::TjuaeUI),
            pinned: false,
            pinned_at: None,
