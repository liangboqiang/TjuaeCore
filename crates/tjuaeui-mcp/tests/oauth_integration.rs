...
use tjuaeui_db::{IOAuthTokenRepository, SqliteOAuthTokenRepository, UpsertOAuthTokenParams};
use tjuaeui_mcp::McpOAuthService;
...
async fn check_status_authenticated_returns_true() {
    ...
    repo.upsert(UpsertOAuthTokenParams {
        ...
        expires_at: Some(tjuaeui_common::now_ms() + 3_600_000),
    })
    .await
    .unwrap();
