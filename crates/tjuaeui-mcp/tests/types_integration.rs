//! Integration tests for tjuaeui-mcp core types.
//!
...
use tjuaeui_mcp::{McpServer, McpServerTransport, McpTool};
...
fn tool_fields_preserved_through_conversion() {
    ...
    // Domain -> API response
    let resp: tjuaeui_api_types::McpToolResponse = tool.clone().into();
