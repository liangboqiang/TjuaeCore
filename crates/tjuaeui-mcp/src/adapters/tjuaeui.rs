...
/// MCP Agent adapter for TjuaeUI itself.
///
/// Unlike CLI-based adapters, this adapter reads/writes directly to the
/// local database. It is always "installed" since TjuaeUI is the host
/// application.
///
/// # Behavior
///
...
impl McpAgentAdapter for TjuaeUIAdapter {
    ...
    async fn install_server(&self, _name: &str, _transport: &McpServerTransport) -> Result<(), McpError> {
        ...
        // TjuaeUI the server is already in the DB.
        Ok(())
    }
