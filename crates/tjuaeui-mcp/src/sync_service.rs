...
use dashmap::DashMap;
use tjuaeui_api_types::{DetectedMcpServerEntry, DetectedMcpServerResponse};
...
fn detected_to_response(detected: DetectedServer) -> DetectedMcpServerEntry {
    ...
    DetectedMcpServerEntry {
        server: tjuaeui_api_types::McpServerResponse {
            ...
            tools: None,
            last_test_status: tjuaeui_common::McpServerStatus::Disconnected,
            last_connected: None,
            original_json: None,
            builtin: false,
            created_at: 0,
