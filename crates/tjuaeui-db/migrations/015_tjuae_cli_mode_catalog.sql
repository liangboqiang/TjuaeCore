-- Migration 015: persist the built-in tjuae_cli mode catalog.
--
-- tjuae_cli is not an ACP backend, so it does not populate agent_metadata through
...
-- stable tjuae_cli runtime mode catalog here.
