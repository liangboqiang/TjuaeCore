-- Migration 001: Consolidated initial schema for tjuaeui-backend
--
-- This is the baseline schema for databases copied from the legacy
-- Electron-managed tjuaeui.db (v26). It creates all tables, indexes,
...
VALUES
    ...
    -- Internal
    ('632f31d2', '/api/assets/logos/brand/tjuae-cli.svg', 'TjuaeCLI',
     NULL, 'tjuaecli', 'internal', '{}',
     1, NULL, '[]', '[]',
     '[".tjuae/skills"]',
     '{"supports_team":true}',
     'yolo', 100,
