...
use tjuaeui_api_types::{TeamAgentResponse, TeamResponse};
...
mod tests {
    ...
    #[test]
    fn teammate_status_parse_tjuaeui_aliases() {
    ...
    #[test]
    fn teammate_status_serde_tjuaeui_aliases() {
    ...
    #[test]
    fn team_agent_deserialize_tjuaeui_format() {
