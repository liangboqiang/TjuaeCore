...
mod tests {
    use super::*;
    use tjuaeui_ai_agent::protocol::events::{ErrorEventData, StartEventData};
...
mod crash_tests {
    use super::*;
    use tjuaeui_ai_agent::protocol::events::ErrorEventData;
    ...
    fn detect_crash_non_error_returns_none() {
        let event = AgentStreamEvent::Start(tjuaeui_ai_agent::protocol::events::StartEventData { session_id: None });
