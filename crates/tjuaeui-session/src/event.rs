...
pub enum SessionEvent {
    ...
    // (No clock/timeout lower: TjuaeCore does NOT auto-time-out a turn. A user may
    ...
    Detached {
        ...
        /// the 14-keyword allowlist in `tjuaeui_common::error_extract` survive,
    ...
    Permission {
        ...
        /// `{ "server_name": "tjuaeui-team"?, "options": [{"option_id","kind"}] }`.
    ...
    /// fields Option — only claude fills them; codex/ACP/tjuae_cli never emit this.
    SubagentDetail {
        r#ref: String,
        parent_ref: Option<String>,
        label: Option<String>,
    ...
    /// projects it to a live tool-output pane. Claude/ACP/tjuae_cli never emit it today.
...
mod additive_tests {
    ...
    fn additive_defaults_keep_old_frames_deserializable() {
        ...
        let new_p = r#"{"Permission":{"request_id":"r","kind":"Tool","metadata":{"server_name":"tjuaeui-team"}}}"#;
