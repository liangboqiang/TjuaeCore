...
use tjuaeui_api_types::{ConversationRuntimeSummary, WebSocketMessage};
use tjuaeui_common::{ErrorChain, normalize_keys_to_snake_case, now_ms};
use tjuaeui_db::models::MessageRow;
use tjuaeui_db::{ConversationRowUpdate, DbError, IConversationRepository, MessageRowUpdate};
...
impl StreamPersistenceAdapter {
    ...
    #[tracing::instrument(skip_all)]
    pub async fn persist_tool_call(&self, data: &tjuaeui_ai_agent::protocol::events::tool_call::ToolCallEventData) {
    ...
    pub async fn persist_acp_tool_call(
        &self,
        data: &tjuaeui_ai_agent::protocol::events::tool_call::AcpToolCallEventData,
    ) {
    ...
    #[tracing::instrument(skip_all)]
    pub async fn persist_tool_group(&self, entries: &[tjuaeui_ai_agent::protocol::events::tool_call::ToolGroupEntry]) {
