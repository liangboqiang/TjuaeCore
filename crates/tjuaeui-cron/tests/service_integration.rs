...
use tjuaeui_ai_agent::agent_task::AgentInstance;
...
impl tjuaeui_ai_agent::task_manager::IWorkerTaskManager for StubTaskManager {
    ...
    fn kill(&self, _: &str, _: Option<tjuaeui_common::AgentKillReason>) -> Result<(), tjuaeui_ai_agent::AgentError> {
        Ok(())
    }
    fn kill_and_wait(
        &self,
...
struct StubConvRepo {
    ...
    artifacts: Mutex<Vec<tjuaeui_db::ConversationArtifactRow>>,
    rows: Mutex<HashMap<String, tjuaeui_db::models::ConversationRow>>,
...
impl StubConvRepo {
    ...
    fn upsert_artifact_row(&self, artifact: tjuaeui_db::ConversationArtifactRow) {
    ...
    fn artifacts(&self) -> Vec<tjuaeui_db::ConversationArtifactRow> {
    ...
    fn set_conversation_extra(&self, conversation_id: &str, extra: serde_json::Value) {
        ...
        let row = rows
            ...
            .or_insert_with(|| tjuaeui_db::models::ConversationRow {
...
impl IConversationRepository for StubConvRepo {
    async fn get(&self, id: &str) -> Result<Option<tjuaeui_db::models::ConversationRow>, tjuaeui_db::DbError> {
        ...
        let row = if id == "conv_mode" {
            tjuaeui_db::models::ConversationRow {
                id: id.into(),
                user_id: "u1".into(),
                ...
                extra: serde_json::json!({
                    "backend": "gemini",
                    "agent_name": "Gemini",
                    "workspace": ensure_named_workspace_path("tjuaeui-cron-service-gemini-workspace"),
                    "session_mode": "yolo",
            ...
            tjuaeui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "hermes",
                    "agent_name": "Hermes",
                    "workspace": ensure_named_workspace_path("tjuaeui-cron-service-hermes-workspace"),
            ...
            tjuaeui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "gemini",
                    "agent_name": "Gemini",
                    "workspace": ensure_named_workspace_path("tjuaeui-cron-service-gemini-default-workspace"),
                    "session_mode": "default",
                    "current_model_id": "gemini-2.5-pro"
                })
                .to_string(),
            ...
            tjuaeui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "codex",
                    "agent_name": "Codex",
                    "workspace": ensure_named_workspace_path("tjuaeui-cron-service-codex-workspace"),
                    "session_mode": "default",
            ...
            tjuaeui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "claude",
                    "agent_name": "Claude",
                    "workspace": ensure_named_workspace_path("tjuaeui-cron-service-claude-workspace"),
                    "session_mode": "default",
            ...
            tjuaeui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "claude",
                    "agent_name": "Gemini",
                    "workspace": ensure_named_workspace_path("tjuaeui-cron-service-stale-backend-workspace"),
                    "session_mode": "yolo",
                    "current_model_id": "gemini-2.5-pro"
                })
                .to_string(),
        ...
        } else if id == "conv_mode_tjuaecli" {
            tjuaeui_db::models::ConversationRow {
                id: id.into(),
                user_id: "u1".into(),
                name: "TjuaeCLI Chat".into(),
                ...
                extra: serde_json::json!({
                    "backend": "anthropic",
                    "agent_name": "TjuaeCLI",
                    "workspace": ensure_named_workspace_path("tjuaeui-cron-service-tjuaecli-workspace"),
                    "session_mode": "default",
                    "current_model_id": "claude-sonnet-4-20250514"
                })
                .to_string(),
            ...
            tjuaeui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    ...
                    "workspace": ensure_named_workspace_path("tjuaeui-cron-service-assistant-stale-backend-workspace"),
            ...
            tjuaeui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    ...
                    "workspace": ensure_named_workspace_path("tjuaeui-cron-service-missing-assistant-stale-backend-workspace")
                })
                .to_string(),
                pinned: false,
                pinned_at: None,
            ...
            tjuaeui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    ...
                    "workspace": ensure_named_workspace_path("tjuaeui-cron-service-assistant-snapshot-workspace")
                })
                .to_string(),
                pinned: false,
                pinned_at: None,
    ...
    async fn create(&self, row: &tjuaeui_db::models::ConversationRow) -> Result<(), tjuaeui_db::DbError> {
    ...
    async fn update(&self, id: &str, updates: &ConversationRowUpdate) -> Result<(), tjuaeui_db::DbError> {
        if self.update_failures.lock().unwrap().iter().any(|item| item == id) {
            return Err(tjuaeui_db::DbError::Init(format!("forced update failure for {id}")));
        }
    ...
    async fn list_artifacts(
        &self,
        conversation_id: &str,
    ) -> Result<Vec<tjuaeui_db::ConversationArtifactRow>, tjuaeui_db::DbError> {
        Ok(self
            .artifacts
            .lock()
            .unwrap()
    ...
    async fn get_artifact(
        ...
        conversation_id: &str,
        artifact_id: &str,
    ) -> Result<Option<tjuaeui_db::ConversationArtifactRow>, tjuaeui_db::DbError> {
        Ok(self
            .artifacts
            .lock()
            .unwrap()
    ...
    async fn upsert_artifact(
        &self,
        artifact: &tjuaeui_db::ConversationArtifactRow,
    ) -> Result<tjuaeui_db::ConversationArtifactRow, tjuaeui_db::DbError> {
...
async fn setup_with_conv_runtime_and_agent_metadata() -> (
    ...
    let task_manager: Arc<dyn tjuaeui_ai_agent::task_manager::IWorkerTaskManager> = Arc::new(StubTaskManager);
...
fn make_create_req(name: &str, schedule: CronScheduleDto) -> CreateCronJobRequest {
    CreateCronJobRequest {
        ...
        execution_mode: None,
        queue_enabled: false,
        agent_config: Some(tjuaeui_api_types::CronAgentConfigWriteDto {
...
async fn create_job_strips_legacy_agent_ids_when_assistant_id_present() {
    ...
    req.agent_config = Some(tjuaeui_api_types::CronAgentConfigWriteDto {
        name: "Helper".into(),
        cli_path: None,
...
async fn create_job_requires_assistant_id_for_new_jobs() {
    ...
    assert!(matches!(err, tjuaeui_cron::error::CronError::InvalidAgentConfig(_)));
    assert!(err.to_string().contains("新建定时任务必须提供 assistant_id"));
}

#[tokio::test]
async fn create_job_derives_runtime_type_from_tjuae_cli_assistant() {
    let (svc, _, _, _, definition_repo, _) = setup_with_assistant_repos().await;
    seed_assistant_definition(
        &definition_repo,
        "asstdef_runtime_tjuaecli",
        "assistant-tjuaecli",
        "tjuaecli",
    )
    .await;

    let mut req = make_create_req("Assistant TjuaeCLI", every_60s());
    req.agent_config = Some(tjuaeui_api_types::CronAgentConfigWriteDto {
        name: "TjuaeCLI Assistant".into(),
        cli_path: None,
        assistant_id: Some("assistant-tjuaecli".into()),
        mode: Some("yolo".into()),
    ...
    assert_eq!(job.agent_type, "tjuaecli");
}
...
async fn create_job_derives_runtime_type_from_assistant_overlay_override() {
    ...
    .await;
    seed_assistant_overlay(&overlay_repo, "asstdef_runtime_override", Some("tjuaecli")).await;
...
async fn cj5_get_nonexistent_job() {
    ...
    assert!(matches!(err, tjuaeui_cron::error::CronError::JobNotFound(_)));
}
...
async fn update_existing_conversation_job_rejects_agent_config_changes() {
    ...
    assert!(matches!(err, tjuaeui_cron::error::CronError::InvalidAgentConfig(message) if message.contains("持续对话")));
}
...
async fn update_existing_job_to_new_conversation_preserves_custom_workspace() {
    ...
    let custom_workspace = ensure_named_workspace_path(&format!("tjuaeui-cron-switch-custom-{conversation_id}"));
    conv_repo.set_conversation_extra(
        &conversation_id,
        serde_json::json!({
...
async fn update_team_conversation_job_rejects_execution_mode_change() {
    ...
    conv_repo.set_conversation_extra(
        ...
        serde_json::json!({
            "team_id": "team-1",
            "workspace": ensure_named_workspace_path("tjuaeui-cron-service-team-workspace")
        }),
    );
    let created = svc.add_job(create_req).await.unwrap();
    ...
    let err = svc.update_job(&created.id, req).await.unwrap_err();
    assert!(matches!(err, tjuaeui_cron::error::CronError::InvalidExecutionMode(message) if message.contains("团队")));
}
...
async fn update_job_rejects_when_assistant_id_cannot_resolve() {
    ...
    assert!(matches!(err, tjuaeui_cron::error::CronError::InvalidAgentConfig(_)));
    assert!(
        err.to_string().contains("找不到助手 'missing-assistant'"),
...
async fn cj9_update_schedule_type() {
    ...
    assert!(matches!(
        updated.schedule,
        tjuaeui_cron::types::CronSchedule::Cron { .. }
    ));
...
async fn cj12_delete_nonexistent() {
    ...
    assert!(matches!(
        err,
        tjuaeui_cron::error::CronError::Database(tjuaeui_db::DbError::NotFound(_))
    ));
}
...
async fn sk1_1_save_skill_marks_related_skill_suggest_artifacts_saved() {
    ...
    conv_repo.upsert_artifact_row(tjuaeui_db::ConversationArtifactRow {
...
async fn sk4_save_empty_skill() {
    ...
    let err = svc
        ...
        .await
        .unwrap_err();
    assert!(matches!(err, tjuaeui_cron::error::CronError::InvalidSkillContent(_)));
}
...
async fn sc5_invalid_cron_expression() {
    ...
    let err = svc.add_job(req).await.unwrap_err();
    assert!(matches!(err, tjuaeui_cron::error::CronError::InvalidCronExpression(_)));
}
...
async fn sc7_every_zero_interval() {
    ...
    let err = svc.add_job(req).await.unwrap_err();
    assert!(matches!(err, tjuaeui_cron::error::CronError::InvalidSchedule(_)));
}
...
async fn create_for_conversation_helper_fails_when_conversation_binding_fails() {
    ...
    assert!(matches!(err, tjuaeui_cron::error::CronError::Database(_)));
    ...
    let response = app
        ...
        .oneshot(
            Request::builder()
                ...
                .header("x-tjuaeui-user-id", "u1")
                .header("x-tjuaeui-conversation-id", "conv_1")
                .body(Body::from(
...
async fn conversation_cron_routes_reject_missing_headers_unclaimed_and_wrong_user() {
    ...
    assert!(body.contains("x-tjuaeui-user-id"));
    ...
    let wrong_user = app
        .oneshot(
            Request::builder()
                ...
                .uri("/api/internal/conversation-cron/create")
                .header("content-type", "application/json")
                .header("x-tjuaeui-user-id", "other_user")
                .header("x-tjuaeui-conversation-id", "conv_1")
                .body(Body::from(
                    serde_json::to_vec(&conversation_cron_request("hello")).unwrap(),
                ))
...
async fn create_for_conversation_helper_rejects_unclaimed_conversation() {
    ...
    assert!(matches!(err, tjuaeui_cron::error::CronError::InvalidAgentConfig(_)));
    assert!(err.to_string().contains("活动对话回合"));
}
...
async fn create_for_conversation_helper_rejects_wrong_user() {
    ...
    assert!(matches!(err, tjuaeui_cron::error::CronError::Conversation(_)));
}
...
async fn sr1_system_resume_missed_job() {
    ...
    let params = tjuaeui_db::UpdateCronJobParams {
...
async fn cd3c_on_conversation_delete_preserves_custom_workspace_on_jobs() {
    ...
    let custom_workspace = ensure_named_workspace_path(&format!("tjuaeui-cron-custom-workspace-{conversation_id}"));
    conv_repo.set_conversation_extra(
        &conversation_id,
        serde_json::json!({
            "workspace": custom_workspace,
