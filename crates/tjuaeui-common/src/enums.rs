...
mod tests {
    ...
    fn test_agent_type_display_names() {
        ...
        assert_eq!(AgentType::TjuaeCli.display_name(), "TjuaeCLI");
    ...
    fn test_agent_type_id_stability() {
        let id = AgentType::TjuaeCli.id();
        assert_eq!(id.len(), 8);
        assert!(id.chars().all(|c| c.is_ascii_hexdigit()));
        assert_eq!(AgentType::TjuaeCli.id(), AgentType::TjuaeCli.id());
    }
    ...
    fn test_mcp_source_serde_roundtrip() {
        let cases = [
            ...
            (McpSource::TjuaeCli, r#""tjuaecli""#),
            (McpSource::Nanobot, r#""nanobot""#),
            (McpSource::TjuaeUI, r#""tjuaeui""#),
        ];
