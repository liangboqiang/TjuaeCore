...
//!
//! Hooks defined here let lower-layer crates (e.g. `tjuaeui-ai-agent`,
//! `tjuaeui-cron`) react to events owned by higher-layer crates (e.g.
//! `tjuaeui-conversation`) without forming a dependency cycle.
