...
///
/// Data is stored in `~/.tjuaeui/custom-skill-paths.json`.
...
impl ExternalPathsManager {
    ...
    /// Enable the tjuaeui skills market by adding it to external paths.
    ...
    /// Disable the tjuaeui skills market by removing it from external paths.
