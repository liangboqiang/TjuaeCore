...
mod tests {
    ...
    fn node_npx_cli_command_spec(cache: &Path, args: &[&str]) -> CommandSpec {
        let mut all_args = vec![r"C:\TjuaeUI\runtime\node\node_modules\npm\bin\npx-cli.js".to_owned()];
...
npm error path /tmp/tjuaeui/runtime/node/cache/_npx/c16927192d2e8dc3/package.json
npm error errno -2
...
";
        ...
        assert_eq!(
            cache_entry,
            std::path::PathBuf::from("/tmp/tjuaeui/runtime/node/cache/_npx/c16927192d2e8dc3")
        );
    }
    ...
    fn detects_corrupt_npm_npx_cache_entry_from_quoted_enoent_path() {
        let stderr = "\
Error: ENOENT: no such file or directory, open '/tmp/tjuaeui/runtime/node/cache/_npx/c16927192d2e8dc3/node_modules/@xai/grok-cli/package.json'
";
    ...
    fn detects_corrupt_npm_npx_cache_entry_from_missing_bin_path() {
        let stderr = "\
sh: /tmp/tjuaeui/runtime/node/cache/_npx/c16927192d2e8dc3/node_modules/.bin/grok: No such file or directory
";
