...
const ACP_CLIENT_NAME: &str = "TjuaeUI";
...
/// Log a JSON-RPC request from TjuaeUI to the ACP agent.
...
/// Log a fire-and-forget notification from TjuaeUI to the agent.
...
/// Log a JSON-RPC response from TjuaeUI back to the agent.
...
mod tests {
    ...
    fn initialize_request_sends_non_empty_client_info() {
        ...
        assert_eq!(client_info.name, "TjuaeUI");
        ...
        assert_eq!(json["clientInfo"]["name"], "TjuaeUI");
