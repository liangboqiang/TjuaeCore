...
use tjuaeui_common::{AgentKillReason, now_ms};
...
const ENV_SOLO_IDLE_TIMEOUT_SECS: &str = "TJUAE_IDLE_TIMEOUT_SECS";
/// Environment variable overriding the team idle timeout, in seconds.
const ENV_TEAM_IDLE_TIMEOUT_SECS: &str = "TJUAE_TEAM_IDLE_TIMEOUT_SECS";
/// Environment variable overriding the idle scan interval, in seconds.
const ENV_IDLE_SCAN_INTERVAL_SECS: &str = "TJUAE_IDLE_SCAN_INTERVAL_SECS";
