...
use tjuaeui_runtime::{NodeRuntimeFailureKind, NodeRuntimeProgress, SharedNodeRuntimeProgressReporter};
...
fn map_phase(phase: tjuaeui_runtime::NodeRuntimeProgressPhase) -> RuntimeStatusPhase {
    match phase {
        tjuaeui_runtime::NodeRuntimeProgressPhase::WaitingForLock => RuntimeStatusPhase::WaitingForLock,
        tjuaeui_runtime::NodeRuntimeProgressPhase::Downloading => RuntimeStatusPhase::Downloading,
        tjuaeui_runtime::NodeRuntimeProgressPhase::Extracting => RuntimeStatusPhase::Extracting,
        tjuaeui_runtime::NodeRuntimeProgressPhase::Validating => RuntimeStatusPhase::Validating,
        tjuaeui_runtime::NodeRuntimeProgressPhase::Ready => RuntimeStatusPhase::Ready,
        tjuaeui_runtime::NodeRuntimeProgressPhase::Failed => RuntimeStatusPhase::Failed,
    }
}
