...
use tjuaeui_api_types::AgentStreamErrorData;
use tjuaeui_common::{ConversationStatus, TimestampMs, now_ms};
...
impl AgentRuntime {
    ...
    /// Only intended for multi-turn agents (e.g. tjuae_cli) where the same
